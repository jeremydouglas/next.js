...
export async function next__polyfill_nomodule(task) {
  await task
    .source(relative(__dirname, require.resolve('@next/polyfill-nomodule')))
    .target('dist/build/polyfills')
}

export async function next__polyfill_module(task) {
  await task
...
export async function copy_regenerator_runtime(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_node_html_parser(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_mswjs_interceptors(task) {
  await task
    .source(
...
export async function copy_vercel_og(task) {
  await task
    .source(
      join(
        relative(
...
export async function ncc_node_fetch(task) {
  await task
...
export async function ncc_node_anser(task) {
  await task
...
export async function ncc_node_stacktrace_parser(task) {
  await task
...
export async function ncc_node_data_uri_to_buffer(task) {
  await task
...
export async function ncc_node_cssescape(task) {
  await task
...
export async function ncc_node_shell_quote(task) {
  await task
...
export async function ncc_node_platform(task) {
  await task
...
export async function ncc_acorn(task) {
  await task
...
export async function ncc_edge_runtime(task) {
...
// eslint-disable-next-line camelcase
export async function ncc_next__react_dev_overlay(task) {
...
export async function ncc_jest_worker(task) {
...
export async function ncc_browserslist(task) {
...
export async function ncc_napirs_triples(task) {
  await task
...
export async function ncc_p_limit(task) {
  await task
...
export async function ncc_raw_body(task) {
  await task
...
export async function ncc_image_size(task) {
  await task
...
export async function ncc_get_orientation(task) {
  await task
...
export async function ncc_hapi_accept(task) {
  await task
...
export async function ncc_amphtml_validator(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_assert(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_browser_zlib(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_buffer(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function copy_react_is(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function copy_constants_browserify(task) {
...
// eslint-disable-next-line camelcase
export async function ncc_crypto_browserify(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_domain_browser(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_events(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_stream_browserify(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_stream_http(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_https_browserify(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_os_browserify(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_path_browserify(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_process(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_querystring_es3(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_string_decoder(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_util(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_punycode(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_set_immediate(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_timers_browserify(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_tty_browserify(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_vm_browserify(task) {
  await task
...
export async function ncc_amp_optimizer(task) {
  await task
    .source(
...
export async function ncc_arg(task) {
  await task
...
export async function ncc_async_retry(task) {
  await task
...
export async function ncc_async_sema(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_postcss_plugin_stub_for_cssnano_simple(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_babel_bundle(task) {
...
// eslint-disable-next-line camelcase
export async function ncc_babel_bundle_packages(task) {
...
// eslint-disable-next-line camelcase
export async function ncc_cssnano_simple_bundle(task) {
  const bundleExternals = {
    ...externals,
...
export async function ncc_bytes(task) {
  await task
...
export async function ncc_ci_info(task) {
  await task
...
export async function ncc_cli_select(task) {
  await task
...
export async function ncc_comment_json(task) {
  await task
...
export async function ncc_compression(task) {
  await task
...
export async function ncc_conf(task) {
  await task
...
export async function ncc_content_disposition(task) {
  await task
...
export async function ncc_content_type(task) {
  await task
...
export async function ncc_cookie(task) {
  await task
...
export async function ncc_debug(task) {
  await task
...
export async function ncc_devalue(task) {
  await task
...
export async function ncc_find_cache_dir(task) {
  await task
...
export async function ncc_find_up(task) {
  await task
...
export async function ncc_fresh(task) {
  await task
...
export async function ncc_glob(task) {
  await task
...
export async function ncc_gzip_size(task) {
  await task
...
export async function ncc_http_proxy(task) {
  await task
...
export async function ncc_ignore_loader(task) {
  await task
...
export async function ncc_is_animated(task) {
  await task
...
export async function ncc_is_docker(task) {
  await task
...
export async function ncc_is_wsl(task) {
  await task
...
export async function ncc_json5(task) {
  await task
...
export async function ncc_jsonwebtoken(task) {
  await task
...
export async function ncc_loader_runner(task) {
  await task
...
export async function ncc_loader_utils2(task) {
  await task
...
export async function ncc_loader_utils3(task) {
  await task
...
export async function ncc_lodash_curry(task) {
  await task
...
export async function ncc_lru_cache(task) {
  await task
...
export async function ncc_nanoid(task) {
  await task
...
export async function ncc_native_url(task) {
  await task
...
export async function ncc_neo_async(task) {
  await task
...
export async function ncc_ora(task) {
  await task
...
export async function ncc_postcss_flexbugs_fixes(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_postcss_safe_parser(task) {
  await task
...
export async function ncc_postcss_preset_env(task) {
  await task
...
export async function ncc_postcss_scss(task) {
  await task
...
export async function ncc_postcss_modules_extract_imports(task) {
  await task
    .source(
...
export async function ncc_postcss_modules_local_by_default(task) {
  await task
    .source(
...
export async function ncc_postcss_modules_scope(task) {
  await task
...
export async function ncc_postcss_modules_values(task) {
  await task
...
export async function ncc_postcss_value_parser(task) {
  await task
...
export async function ncc_icss_utils(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_rsc_poison_packages(task) {
  await task
...
export async function ncc_schema_utils2(task) {
  await task
...
export async function ncc_schema_utils3(task) {
  await task
...
export async function ncc_semver(task) {
  await task
...
export async function ncc_send(task) {
  await task
...
export async function ncc_source_map(task) {
  await task
...
export async function ncc_string_hash(task) {
  await task
...
export async function ncc_strip_ansi(task) {
  await task
...
export async function ncc_nft(task) {
  await task
...
export async function ncc_tar(task) {
  await task
...
export async function ncc_terser(task) {
  await task
...
export async function ncc_text_table(task) {
  await task
...
export async function ncc_unistore(task) {
  await task
...
export async function ncc_superstruct(task) {
  await task
...
export async function ncc_zod(task) {
  await task
...
export async function ncc_web_vitals(task) {
  await task
    .source(
      relative(
        __dirname,
...
export async function ncc_web_vitals_attribution(task) {
  await task
    .source(
      relative(
        __dirname,
...
export async function ncc_webpack_sources1(task) {
  await task
...
export async function ncc_webpack_sources3(task) {
  await task
...
export async function ncc_minimatch(task) {
  await task
...
export async function ncc_ua_parser_js(task) {
  await task
...
// eslint-disable-next-line camelcase
export async function ncc_webpack_bundle5(task) {
  const bundleExternals = {
    ...externals,
    'schema-utils': externals['schema-utils3'],
...
export async function ncc_webpack_bundle_packages(task) {
  await task
...
export async function ncc_ws(task) {
  await task
...
export async function path_to_regexp(task) {
  await task
...
export async function ncc_http_proxy_agent(task) {
  await task
...
export async function ncc_https_proxy_agent(task) {
  await task
...
export async function server_wasm(task) {
  await task.source('src/server/**/*.+(wasm)').target('dist/server')
}

export async function experimental_testmode(task) {
  await task
